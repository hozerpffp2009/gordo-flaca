              ...
              <Card style={{width: "18rem"}} className="Card">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    specializes in helping homeowners sell their houses without
                    agents, fees, or commissions! It doesn't matter what reason
                    you have for selling, or the condition of your property - we
                    can help. We make all CASH offers, and close quickly.
                  </Card.Text>
                </Card.Body>
                <Card.Body>
            ...
            <Fade right>
              <Card style={{width: "18rem"}} className="Card">
                ...
                <Card.Body>
                  ...
                  <Card.Title className="title">Any Home Condition</Card.Title>
                  <Card.Text>
        ...
        <div class="row">
          <div className="column">
            <Fade right>
              <Card style={{width: "18rem"}} className="Card">
                <Card.Body>
                  <FontAwesomeIcon id="home" icon={faMoneyBillAlt} size="3x" />
              ...
              <Card style={{width: "18rem"}} className="Card">
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    agents, fees, commissions, showings, being listedon the MLS,
                    or waiting months to close... then click the button below
                    now. We can make a fair cash offer on your home and close
                    quickly (in as little as 7 days). You are under No
